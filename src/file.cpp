...
const SolveSpaceUI::SaveTable SolveSpaceUI::SAVED[] = {
    ...
    { 'g',  "Group.threadParamExpr6",   'S',    &(SS.sv.g.threadParamExpr[0]) },
    { 'g',  "Group.threadParamExpr7",   'S',    &(SS.sv.g.threadParamExpr[1]) },
    { 'g',  "Group.threadParamExpr8",   'S',    &(SS.sv.g.threadParamExpr[2]) },
    { 'g',  "Group.threadParamExpr9",   'S',    &(SS.sv.g.threadParamExpr[3]) },
    { 'g',  "Group.threadParamExpr10",  'S',    &(SS.sv.g.threadParamExpr[4]) },
    { 'g',  "Group.threadParamExpr11",  'S',    &(SS.sv.g.threadParamExpr[5]) },
